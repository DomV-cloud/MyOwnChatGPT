...
function App() {
  ...
  async function handleSubmit(e) {
    ...
    /* Append the new chat message to the existing chat log */
    ...
    /* Send the chat log as a JSON object */
    ...
    /* Update the state with the new chat log and reset the input */
    setChatLog(chatLog => [...newChatLog, { user: "gpt", message: `${data.message}` }]);
    ...
    <div className={`chat-message ${message.user === "gpt" && "chatgpt"}`}>
            <div className="chat-message-center">
              <div className={`avatar ${message.user === "gpt" && "chatgpt"}`}>
                 {message.user === "gpt" &&  <svg width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg"  >
